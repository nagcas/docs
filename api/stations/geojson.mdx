...
<ParamField query="limit" type="integer" default="50">
  Number of station features to return per page. Must be a positive integer greater than 0.
...
# Fetch GeoJSON data
url = "https://api.terraquakeapi.com/stations/geojson?limit=500"
