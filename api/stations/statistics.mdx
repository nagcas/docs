...
if (data.success) {
  ...
  const inactivePercent = (stats.stationsClosed / stats.totalStations * 100).toFixed(1);
...
func main() {
    resp, err := http.Get("https://api.terraquakeapi.com/stations/statistics")
    if err != nil {
        panic(err)
    }
...
<ResponseField name="payload" type="object">
  ...
  <ResponseField name="statistics" type="object">
    ...
    <ResponseField name="totalStations" type="integer">
      Total number of stations in the network (active + inactive)
    </ResponseField>
    
    <ResponseField name="stationsOpen" type="integer">
      Number of currently operational stations (status: "open")
    </ResponseField>
    
    <ResponseField name="stationsClosed" type="integer">
...
<CardGroup cols={2}>
  ...
  <Card title="Stations Overview" icon="book" href="/api/stations/overview">
