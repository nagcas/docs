---
title: "GET /stations/status/open"
...
const response = await fetch(
  'https://api.terraquakeapi.com/stations/status/open?limit=100'
);
...
if (data.success) {
  ...
  const sicilianStations = data.payload.filter(station => 
...
```php PHP
<?php
$url = "https://api.terraquakeapi.com/stations/status/open?limit=100";
...
<ResponseField name="totalStationsOpen" type="integer">
