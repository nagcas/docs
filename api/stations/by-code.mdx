...
<ParamField query="code" type="string" required>
  The unique station code to search for. Case-insensitive.
  
  **Examples**: "ACATE", "IV.ACER", "MONC"
  
  **Format**: Alphanumeric, may include periods for network prefix
</ParamField>
...
station_code = "ACATE"
url = f"https://api.terraquakeapi.com/stations/code?code={station_code}"
...
<?php
$stationCode = "ACATE";
$url = "https://api.terraquakeapi.com/stations/code?code=" . urlencode($stationCode);
...
<ResponseField name="codeStation" type="string">
