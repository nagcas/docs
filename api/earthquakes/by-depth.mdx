...
<CardGroup cols={3}>
  <Card title="Shallow" icon="layer-group">
    **0-70 km**
    
    Most common type. Occur in Earth's crust. Can cause significant damage due to proximity to surface.
  </Card>
  
  <Card title="Intermediate" icon="layer-group">
    **70-300 km**
    
    Occur in subduction zones. Less common but can still be felt at surface.
  </Card>
  
  <Card title="Deep" icon="layer-group">
    **300-700 km**
    
    Occur in subduction zones. Rare and typically less damaging at surface.
  </Card>
</CardGroup>
