...
>
  ...
  (string) - Event type ("earthquake") - `place` (string) - Location description
  - `version` (integer) - Version number - `geojson_creationTime` (string) -
  GeoJSON creation time **Geometry:** - `type` (string) - Always "Point" -
