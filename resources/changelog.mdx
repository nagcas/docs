...
<Card title="API Documentation Routes" icon="file-lines">
  Added TerraQuake API documentation routes and controller for better API discoverability
</Card>

### December 2025

<Card title="User Management Improvements" icon="users">
...
<Card title="Frontend Enhancements" icon="browser">
...
<Card title="Route Refactoring" icon="route">
...
<Card title="Package Updates" icon="box">
...
<Warning>
  **Version 1.0.0** is the initial stable release. No breaking changes have been introduced yet.
  
  Future major version updates will be documented here with migration guides.
</Warning>
...
<Card title="View All Releases" icon="github" href="https://github.com/nagcas/TerraQuakeApi/releases">
...
<Card title="Full Commit History" icon="code-commit" href="https://github.com/nagcas/TerraQuakeApi/commits/main">
...
<CardGroup cols={2}>
  <Card title="Watch on GitHub" icon="star" href="https://github.com/nagcas/TerraQuakeApi">
  ...
  <Card title="Follow Development" icon="github" href="https://github.com/nagcas/TerraQuakeApi/issues">
    Track upcoming features and bug fixes
  </Card>
  
  <Card title="RSS Feed" icon="rss" href="https://github.com/nagcas/TerraQuakeApi/releases.atom">
